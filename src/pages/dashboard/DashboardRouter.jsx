...
export const DashboardRouter = () => {
  ...
  const isDedicatedRole = user && ['ROOT_ADMIN', 'SUPER_ADMIN', 'ADMIN', 'TEACHER', 'HM', 'STUDENT', 'SUPERVISOR', 'PARENT'].includes(user.role);
  ...
  // PARENT: Comprehensive child tracking workspace
  if (user.role === 'PARENT') {
